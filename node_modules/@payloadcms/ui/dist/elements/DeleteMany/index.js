...
export const DeleteMany = props => {
  ...
  const hasDeletePermission = hasDeletePermissionFromProps !== undefined ? hasDeletePermissionFromProps : Boolean(collectionPermissions?.delete);
  const hasTrashPermission = hasTrashPermissionFromProps !== undefined ? hasTrashPermissionFromProps : hasDeletePermission;
  ...
  const canShowDeleteButton = isTrashView ? hasDeletePermission : hasDeletePermission || hasTrashPermission;
...
export function DeleteMany_v4({
  ...
  const handleDelete = React.useCallback(async () => {
    ...
    for (const [relationTo, {
      ...
      if (collectionConfig) {
        ...
        const deleteManyResponse = permanentlyDelete ? await requests.delete(url, {
          headers: {
  ...
  }, [selections, afterDelete, collections, deletePermanently, hasDeletePermission, hasTrashPermission, locale, search, api, i18n, viewType, where, t]);
  const {
    label: labelString,
    ...
    children: [/*#__PURE__*/_jsx(ListSelectionButton, {
      ...
      body: /*#__PURE__*/_jsxs(React.Fragment, {
        children: [/*#__PURE__*/_jsx("p", {
          children: trash && hasTrashPermission ? viewType === 'trash' ? /*#__PURE__*/_jsx(Translation, {
            elements: {
              '0': ({
                children
        ...
        }), trash && hasTrashPermission && hasDeletePermission && viewType !== 'trash' && /*#__PURE__*/_jsx("div", {
