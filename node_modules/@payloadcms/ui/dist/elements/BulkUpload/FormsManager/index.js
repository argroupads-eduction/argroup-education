...
export function FormsManagerProvider({
  ...
  const applyFolderToState = React.useCallback(baseState => {
  ...
  }, [initializeSharedFormState, hasInitializedState, toggleLoadingOverlay, activeIndex, forms, applyFolderToState]);
  ...
  const addInitialForms = useEffectEvent(async initialForms_0 => {
    ...
    dispatch({
      ...
      forms: initialForms_0.map(form_0 => ({
        ...form_0,
        initialState: applyFolderToState(form_0?.initialState || initialStateRef.current)
      }))
    });
    toggleLoadingOverlay({
      isLoading: false,
