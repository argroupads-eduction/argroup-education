...
export const DeleteDocument = props => {
  ...
  const handleDelete = useCallback(async () => {
    ...
    try {
      ...
      const res = permanentlyDelete ? await requests.delete(url, {
        headers: {
      ...
      if (res.status < 400) {
        toast.success(t(permanentlyDelete ? 'general:titleDeleted' : 'general:titleTrashed', {
  ...
  }, [deletePermanently, setModified, hasDeletePermission, hasTrashPermission, api, collectionSlug, id, t, singularLabel, addDefaultError, i18n, title, router, adminRoute, redirectAfterDelete, onDelete, collectionConfig, startRouteTransition]);
  if (id) {
      ...
      children: [/*#__PURE__*/_jsx(PopupList.Button, {
        ...
        body: /*#__PURE__*/_jsxs(Fragment, {
          children: [/*#__PURE__*/_jsx(Translation, {
            ...
            i18nKey: collectionConfig.trash && hasTrashPermission ? 'general:aboutToTrash' : 'general:aboutToDelete',
            t: t,
            variables: {
              label: getTranslation(singularLabel, i18n),
              title: titleFromProps || title || id
            }
          }), collectionConfig.trash && hasTrashPermission && hasDeletePermission && /*#__PURE__*/_jsx("div", {
