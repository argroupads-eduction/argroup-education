        ...
        children: /*#__PURE__*/_jsxs(SelectionProvider, {
          ...
          children: [BeforeList, /*#__PURE__*/_jsxs(Gutter, {
            ...
            children: [/*#__PURE__*/_jsx(CollectionListHeader, {
              ...
              Description: Description || collectionConfig?.admin?.description ? /*#__PURE__*/_jsx("div", {
            ...
            }), docs?.length === 0 && /*#__PURE__*/_jsx(NoListResults, {
              Actions: hasCreatePermission && newDocumentURL && viewType !== 'trash' ? [isInDrawer ? /*#__PURE__*/_jsx(Button, {
                el: "button",
                onClick: () => openModal(createNewDrawerSlug),
                children: i18n.t('general:createNewLabel', {
                  label: getTranslation(labels?.singular, i18n)
                })
              }, "create") : /*#__PURE__*/_jsx(Button, {
                el: "link",
                to: newDocumentURL,
                children: i18n.t('general:createNewLabel', {
                  label: getTranslation(labels?.singular, i18n)
              ...
              Message: viewType === 'trash' ? /*#__PURE__*/_jsx("p", {
                children: i18n.t('general:noTrashResults', {
                  label: getTranslation(labels?.plural, i18n)
                })
