...
describe('appendCacheTag', () => {
  it('should return the url unchanged when cacheTag is undefined', () => {
    expect(appendCacheTag('https://example.com/image.jpg', undefined)).toBe('https://example.com/image.jpg');
  });
  it('should return the url unchanged when cacheTag is false', () => {
    expect(appendCacheTag('https://example.com/image.jpg', false)).toBe('https://example.com/image.jpg');
  });
  it('should return the url unchanged when cacheTag is empty string', () => {
    expect(appendCacheTag('https://example.com/image.jpg', '')).toBe('https://example.com/image.jpg');
  });
  ...
  it('should append the cache tag with & when the url already has a query string', () => {
    const result = appendCacheTag('https://example.com/image.jpg?w=800&q=75', '2024-01-01T00:00:00.000Z');
...
//# sourceMappingURL=appendCacheTag.spec.js.map