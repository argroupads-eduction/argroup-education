...
FROM cms.posts WHERE slug IN ('is-neet-essential-for-mbbs-in-another-country',
  'six-things-to-consider-before-pursuing-an-mbbs-abroad',
  'perfect-protocol-for-acquiring-mbbs-degree-abroad',
  'a-comprehensive-guide-for-indian-medical-aspirants-to-mbbs-in-india',
  'nmc-regulations-for-transfer-of-indian-students-pursuing-mbbs-abroad',
  ...
  'neet-2026-admit-card',
  'dream-becoming-a-doctor',
  'everything-know-about-re-neet-2026') AND _status = 'draft'
UNION ALL
SELECT 'blogpost_unpublished', count(*)::int
FROM public."BlogPost" WHERE slug IN ('is-neet-essential-for-mbbs-in-another-country',
  'six-things-to-consider-before-pursuing-an-mbbs-abroad',
  'perfect-protocol-for-acquiring-mbbs-degree-abroad',
  'a-comprehensive-guide-for-indian-medical-aspirants-to-mbbs-in-india',
  'nmc-regulations-for-transfer-of-indian-students-pursuing-mbbs-abroad',
  ...
  'neet-2026-admit-card',
  'dream-becoming-a-doctor',
  'everything-know-about-re-neet-2026') AND published = false;
