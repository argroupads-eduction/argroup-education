...
export function MbbsAbroadScrollSection() {
  ...
  return (
    <section
      ref={containerRef}
      id="mbbs-abroad"
      className="relative scroll-mt-[var(--site-sticky-header)]"
      style={{ height: sectionHeight }}
      aria-label="MBBS Abroad destinations"
    >
      <div className="sticky top-[var(--site-sticky-header)] z-10 flex min-h-[calc(100dvh-var(--site-sticky-header))] w-full items-start overflow-x-hidden overflow-y-auto bg-navy-900 md:items-center">
        <motion.div
        ...
        <div className="relative z-[1] mx-auto w-full max-w-7xl px-4 py-8 md:px-8 md:py-10 lg:py-12">
