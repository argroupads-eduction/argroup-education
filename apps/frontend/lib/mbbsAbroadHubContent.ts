...
export const MBBS_ABROAD_HUB = {
  ...
  highlights: [
    {
      ...
      abroad: 'Qualifying NEET score required for Indian students (NMC norms)',
      india: 'Mandatory for government & most private seats',
    },
    {
      feature: 'Course duration',
      abroad: 'Typically 5–6 years including internship (country-specific)',
      india: '5.5 years (including internship)',
    },
    {
      feature: 'Medium of instruction',
      abroad: 'English or bilingual tracks depending on country',
      india: 'English',
    },
    {
      feature: 'Recognition',
      abroad: 'WHO-listed universities; FMGE/NExT pathway for practice in India',
      india: 'NMC-recognised colleges in India',
    },
    {
    ...
    },
    {
      ...
      abroad: 'University shortlist, visa, forex & departure briefing',
      india: 'State counselling & college selection guidance',
    },
  ],
  countryInsights: [
    {
      name: 'Russia',
      text: 'Large intake, established medical universities, and structured English programmes. Popular for students seeking recognised degrees with comparatively predictable fee bands. Winter climate and longer travel time should be planned early.',
    },
    {
      name: 'Nepal',
      text: 'Geographic proximity to India, familiar culture, and shorter travel for families. Several universities attract Indian students for affordable programmes and straightforward admission cycles.',
    },
    {
      name: 'Bangladesh',
    ...
    },
    {
      ...
      text: 'Growing destinations with modern campuses and transparent academic calendars. Compare city living costs and hostel options when shortlisting.',
    },
    {
      name: 'Georgia',
    ...
    {
      name: 'Philippines',
      text: 'US-style pre-med plus MD pathway for some programmes. Understand total duration, licensing steps, and climate adaptation before enrolling.',
    },
  ],
  costFactors: [
    'Tuition per year (confirm whether hostel, library, or exam fees are separate).',
  ...
  benefits: [
    {
      title: 'Affordable tuition bands',
      text: 'Several destinations offer structured fee plans that suit middle-income families when compared with premium private medical colleges in India.',
    },
    {
      title: 'Global clinical exposure',
      text: 'Training in international hospitals builds confidence for licensing exams and future postgraduate planning.',
    },
    {
      title: 'English-medium options',
      text: 'Popular countries provide English-taught programmes with clear academic calendars and defined internship phases.',
    },
    {
      title: 'Structured admission support',
      text: 'From university application to visa and travel, AR Group coordinates each milestone with document checklists.',
    },
    {
      title: 'NMC-aligned guidance',
      text: 'We explain screening exam requirements and help you verify university listing before you pay any fee.',
    },
    {
  ...
  process: [
    ...
    { step: '05', title: 'Pre-departure', text: 'Packing, travel, hostel, and airport coordination.' },
    { step: '06', title: 'Enrollment abroad', text: 'On-campus registration and local support where available.' },
  ],
  faqs: [
    {
      question: 'Is NEET mandatory for MBBS abroad?',
      answer:
        'Yes. Indian students generally need a qualifying NEET score for the admission year to pursue MBBS abroad under current NMC guidelines. Always verify the latest notification before applying.',
    },
    {
      question: 'Which countries are popular for Indian students?',
      answer:
        'Russia, Nepal, Bangladesh, Kazakhstan, Uzbekistan, Georgia, and the Philippines are among the most requested destinations on our platform. Each has different fees, climate, and licensing pathways.',
    },
    {
    ...
    },
    {
      ...
      answer:
        'Use official fee schedules on each college page, add living costs for the city, and confirm currency conversion with our counsellors. Avoid verbal promises not backed by university letters.',
    },
    {
    ...
    },
    {
      ...
      answer:
        'Colleges are grouped by country. Click a university card for fees and eligibility, or open the country hub to compare all options in that destination.',
    },
    {
