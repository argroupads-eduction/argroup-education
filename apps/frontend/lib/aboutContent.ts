...
export const ABOUT_STATS = [
  { value: '4000+', label: 'Students counselled' },
...
export const ABOUT_HIGHLIGHTS = [
  {
    ...
    text: 'WHO-listed universities, country comparison, and transparent fee counselling across Russia, Georgia, Kazakhstan, and more.',
    href: '/mbbs-abroad',
  },
  {
    id: 'mbbs-india',
    title: 'MBBS in India',
    text: 'State-wise NEET counselling, private & deemed college shortlists, and admission support across India.',
    href: '/mbbs-india',
  },
  {
    id: 'md-ms',
    title: 'MD / MS counselling',
    text: 'Postgraduate medical admission guidance with state-wise PG counselling strategy and seat selection support.',
    href: '/md-ms',
  },
  {
    id: 'universities',
    title: 'Verified university network',
    text: 'Partnerships with reputed medical institutions offering modern campuses, English-medium programs, and global exposure.',
    href: '/mbbs-abroad',
  },
  {
    id: 'visa',
...
export const ABOUT_TIMELINE = [
  {
    year: '2005',
    title: 'Founded with a single promise',
    text: 'AR Group of Education starts as a dedicated medical admission counselling desk in India.',
  },
  {
    year: '2012',
    title: 'India-wide NEET guidance',
    text: 'Expanded state-wise MBBS counselling for private, deemed, and government quota pathways.',
  },
  {
    year: '2016',
    title: 'Global university partnerships',
    text: 'Built a vetted network of MBBS abroad destinations with transparent admission playbooks.',
  },
  {
    year: '2020',
  ...
  {
    year: 'Today',
    title: '4000+ students & counting',
    text: 'Full-stack support for MBBS India, MBBS abroad, MD/MS, and ongoing student success.',
  },
] as const;
...
export const ABOUT_PROCESS = [
  ...
  { step: '05', title: 'Fly & thrive', text: 'Airport support, hostel onboarding, and alumni connect at destination.' },
] as const;
...
export const ABOUT_COMMITMENTS = [
  ...
  },
  {
    ...
    text: 'We shortlist NMC/WHO-aligned institutions with documented admission track records.',
  },
  {
    id: 'personal',
    title: 'One counsellor, end-to-end',
    text: 'Your case stays with the same advisor from NEET counselling to airport departure.',
  },
  {
    id: 'parents',
    title: 'Parents in the loop',
    text: 'WhatsApp updates, document checklists, and call-backs so families never feel left out.',
  },
] as const;

export const ABOUT_TRUST_PILLARS = [
  { value: '19+', label: 'Years counselling', detail: 'Since 2005' },
  { value: '500+', label: 'Partner colleges', detail: 'India & abroad' },
  { value: '15+', label: 'Countries covered', detail: 'MBBS abroad hubs' },
  { value: '24/7', label: 'Student helpline', detail: 'Pre & post admission' },
] as const;
...
export const ABOUT_DIFFERENTIATORS = [
  ...
  },
  {
    ...
    text: 'Local coordinators, hostel walkthroughs, and alumni connects at major destinations.',
  },
] as const;
