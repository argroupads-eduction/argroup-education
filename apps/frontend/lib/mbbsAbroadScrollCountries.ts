...
export const MBBS_ABROAD_SCROLL_COUNTRIES: MbbsAbroadScrollCountry[] = [
  {
    ...
    accent: '#60a5fa',
    imageSrc: '/mbbs-abroad-scroll/russia.webp',
  },
  {
    name: 'Nepal',
    slug: 'nepal',
    ...
    accent: '#fca5a5',
    imageSrc: '/mbbs-abroad-scroll/nepal.webp',
  },
  {
    name: 'Uzbekistan',
    slug: 'uzbekistan',
    ...
    accent: '#668bc2',
    imageSrc: '/mbbs-abroad-scroll/uzbekistan.webp',
  },
  {
    name: 'Kazakhstan',
    slug: 'kazakhstan',
    ...
    accent: '#93c5fd',
    imageSrc: '/mbbs-abroad-scroll/kazakhstan.webp',
  },
  {
    name: 'Georgia',
    slug: 'georgia',
    ...
    accent: '#a5b4fc',
    imageSrc: '/mbbs-abroad-scroll/georgia.webp',
  },
]
