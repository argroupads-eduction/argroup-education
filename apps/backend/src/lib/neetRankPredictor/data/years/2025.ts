...
/** NTA-verified single-score points (PW / NTA result PDF). Used for marks ≥ 516. */
export const NTA_2025_TOP_POINTS: readonly { marks: number; air: number }[] = [
  { marks: 686, air: 1 },
  { marks: 682, air: 2 },
  { marks: 681, air: 3 },
  { marks: 678, air: 8 },
...
/** NTA NEET UG 2025 — official marks vs AIR. */
export const NEET_2025: NeetYearDataset = {
  year: 2025,
...
/**
 * NTA 2025 mark-band ranges for marks 144–515 only.
 * Bands above 515 are excluded — they conflict with verified NTA point data (516→35000 etc.).
 */
export const NTA_2025_BANDS: readonly {
  marksMax: number;
  marksMin: number;
  airMin: number;
  airMax: number;
...
/** Careers360 / NTA published coarse ranges for display & cross-check. */
export const NTA_2025_COARSE_RANGES: readonly {
  marksMin: number;
  marksMax: number;
  rankMin: number;
  rankMax: number;
}[] = [
  { marksMin: 499, marksMax: 450, rankMin: 90001, rankMax: 150000 },
  { marksMin: 449, marksMax: 400, rankMin: 150001, rankMax: 250000 },
  { marksMin: 399, marksMax: 350, rankMin: 250001, rankMax: 350000 },
  { marksMin: 349, marksMax: 300, rankMin: 350001, rankMax: 450000 },
];
